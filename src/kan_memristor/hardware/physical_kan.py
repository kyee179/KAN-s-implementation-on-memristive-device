"""Memristive polynomial KAN layers and pulse-based training.

This module supports two hardware simulation levels.

* Finite-state mode: conductance updates jump between ideal RRAM levels.
* Complete physical mode: polynomial voltage rows are generated by a differentiable
...
class PhysicalOddPolynomialKANLayer(nn.Module):
    """Polynomial KAN layer represented by differential RRAM pairs."""
    ...
    def from_software_layer(
        ...
        """Map a trained software polynomial layer onto RRAM pairs."""
...
class PhysicalOddPolynomialKAN(nn.Module):
    """Stack of memristive polynomial KAN layers."""
